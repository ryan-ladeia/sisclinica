...
<body>
    ...
    <aside class="sidebar">
        <div class="menu">
            ...
            <br> <br> <br> <br>
            <a href="listamedico.php" class="menu-item"><img src="../imagens/doctor.svg" class="logo" width="35px"></a> 
            <br> <br> <br> <br>
            <a href="cadastroconvenio.php" class="menu-item"><img src="../imagens/convenio.svg" class="logo" width="35px"></a>  
            <br> <br> <br> <br>
            <a href="listaconsultorio.php" class="menu-item"><img src="../imagens/hospital.svg" class="logo" width="35px"></a>
        </div>
    </aside>

    <main class="main-content-cad">
    <header class="header-cad">
                <h1>Agenda de Consulta</h1>
                <a href="criaconsulta.php" class="add"> <img src="../imagens/calendariomais.svg" width="35px"></a>
            </header>
        <table> 
            <thead>
                <!--tr>
