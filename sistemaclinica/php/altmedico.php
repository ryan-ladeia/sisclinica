...
if (isset($_POST['id']) && !empty($_POST['id'])) {
    ...
    if ($array_retorno) {
        ...
        $consultorio_medico = $array_retorno['consultorio'];  
...
$conn = new mysqli("ceteia.guanambi.ifbaiano.edu.br:3306", "sisclinica", "sisclinica", "sisclinica");
